...
export interface ModalUpdateProps {
    ...
    keys?: DateAnalysingResponse
    mutationUpdate: any;
}

const UpdateDate: FC<ModalUpdateProps> = ({ openModalUpdate, setOpenModalUpdate, keys, mutationUpdate }) => {
                            ...
                            <div className="px-6 py-6 lg:px-8">
                                ...
                                <form className="space-y-6" action="#">
                                    <div className="mb-2 block">
                                        <Label value={"Old date"} />
                                    </div>
                                    <TextInput
                                        placeholder={keys?.date}
