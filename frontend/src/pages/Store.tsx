...
const Store: FC = () => {
    ...
    const { data } = useQuery([{ name }], () => StoreService.get(),)

    const { mutate: mutationAdd } = useMutation({
        mutationFn: StoreService.post,
        onSuccess: () => {
    ...
    const { mutate: mutateExport } = useMutation({
        mutationFn: StoreService.export,
        onSuccess: (data) => {
    ...
    const { mutate: mutateImport } = useMutation({
        mutationFn: StoreService.import,
        onSuccess: () => {
