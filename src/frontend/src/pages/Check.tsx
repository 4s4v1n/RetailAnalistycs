...
const Card: FC = () => {
    ...
    const { data } = useQuery([{ name }], () => CheckService.get(),)

    const { mutate: mutationAdd } = useMutation({
        mutationFn: CheckService.post,
        onSuccess: () => {
    ...
    const { mutate: mutationDelete } = useMutation({
        mutationFn: CheckService.delete,
        onSuccess: () => {
    ...
    const { mutate: mutateExport } = useMutation({
        mutationFn: CheckService.export,
        onSuccess: (data) => {
    ...
    const { mutate: mutateImport } = useMutation({
        mutationFn: CheckService.import,
        onSuccess: () => {
